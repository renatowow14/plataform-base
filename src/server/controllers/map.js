...
module.exports = function (app) {
            ...
            groups: [
                {
                    ...
                    layers: [{
                        ...
                        order: 2,
                        typeLayer: "vectorial",
                        typeLabel: languageJson["typelabelLayer"]["type"][language],
                        timeLabel: languageJson["typelabelLayer"]["year"][language],
    ...
    Controller.new_descriptor = function (request, response) {
        var language = request.param('lang')

        var result = {
            // regionFilterDefault: "bioma='CERRADO'", // Non-obrigatory property to define a filter to Region applied to EVERY layer.
            groups: DescriptorBuilder().getGroupLayers(language),
            basemaps: DescriptorBuilder().getBasemapsOrLimitsLayers(language, 'basemaps'),
            limits: DescriptorBuilder().getBasemapsOrLimitsLayers(language, 'limits'),
        }
