    ...
    Controller.chartsFarming = function(request, response) {
        ...
        for (let classe of[...classes]) {
            ...
            if (classe == 'Pastagem') {
                ...
                dataInfo.datasets.push({
                    ...
                    data: Internal.getValues(request, 'Rebanho Bovino', 'lotacao_bovina_regions'),
                    fill: false,
            ...
            dataInfo.datasets.push({
                label: classe,
                data: Internal.getValues(request, classe, indicator),
                fill: false,
                backgroundColor: color,
                borderColor: color
            })
        ...
        var chartResult = [

            {
                ...
                "data": Internal.getDataSets(request, 'pasture'),
                "type": 'line',
                "options": {
                    legend: {
                        display: false
